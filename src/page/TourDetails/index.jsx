        ...
        <div style={{ marginTop: 70 }}>
            ...
            <Card>
              ...
              <div style={{ gap: 10, display: "flex", padding: 10 }}>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                  <Text className="text">Departure {tour.departure}</Text>
                  <Text className="text">
                    Departure date: {formatDate(tour.schedule)}
                  </Text>
                </div>
              </div>
              <div
              ...
              >
                <Text className="text">Price from:</Text>
                <Text
                  className="text"
                ...
                <div>
                  <Form>
                    ...
                    >
                      ...
                      <div>
                        <Text style={{ marginBottom: 10 }}>Departure: </Text>
                        <Select
                          defaultValue="Hà Nội"
                    ...
                    >
                      ...
                      <div>
                        <Text style={{ marginBottom: 10 }}>Fullname: </Text>
                        <Input
                          placeholder="Họ tên"
                          style={{ width: "230px", height: "40px" }}
          ...
          <div style={{ marginTop: 50 }}>
            <div style={{ marginBottom: 10 }}>
              <Title level={3}>Tour description</Title>
              <Text className="text">{tour.description}</Text>
            </div>
            <div ref={itineraryRef}>
              <Title level={3}>Highlights</Title>
              {tour.highlight &&
                tour.highlight.split(/(?<=\.)\s*/).map((sentence, index) => (
            ...
            <div style={{ marginTop: 50 }}>
              <Title level={3}>Tour schedule</Title>
